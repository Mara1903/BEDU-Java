...
// Definir la clase Tema e implementar Comparable para ordenar por título
...
public class PlaneacionEducativa {
    public static void main(String[] args) {
        ...
        // Crear una lista concurrente de temas usando CopyOnWriteArrayList
        CopyOnWriteArrayList<Tema> temas = new CopyOnWriteArrayList<>();
        temas.add(new Tema("Lectura comprensiva", 2));
        temas.add(new Tema("Matemáticas básicas", 1));
        temas.add(new Tema("Cuidado del medio ambiente", 3));

        // Ordenar los temas alfabéticamente usando Comparable
        ...
        // Crear un mapa concurrente de recursos usando ConcurrentHashMap
